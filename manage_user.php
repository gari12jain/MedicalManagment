...
.buttons a {
	...
	<body>
        ...
        <table border="4" cellspacing="10" cellpadding="10";>
         ...
         <?php
                while($arr=mysqli_fetch_assoc($rsu))
                {
                      $name = $arr['name'];
                      $address= $arr['address']; 
                      $email = $arr['email']; 
               ...
               ?>
                ...
                <tr> 
                   ...
                   <td><?php echo $phone_no;?></td>
                    ...
                    <td><a href="active.php">Active</a>
                   <a href="remove.php?del=<?php echo $arr['name'];?>">Remove</a>
				   <a href="block.php">Block</a></td>
               </tr>
          <?php
                }
                ?>
