			...
			<ul class="product_gallary">
				<li>
                 ...
                 <div class="product_description">
                 	...
                 	<a href="book.php?rn=budecort & sb=70"  class="buy_now">Buy now</a>
                 </div>
				</li>
				...
				<li>
                 ...
                 <div class="product_description">
                 	<p>This is used for the treatment of asthama.This is of highly reactive medicine.</p>
                 	<a href='showmedicine.php?rn=crosin & sb=40' class="buy_now">Buy now</a>
                 </div>
				</li>
				...
				<li>
                 ...
                 <div class="product_description">
                 	<p>This is used for the treatment of asthama.This is of highly reactive medicine.</p>
                 	<a href='book.php?rn=Lanol & sb=35' class="buy_now">Buy now</a>
                 </div>
				</li>
				...
				<li>
                 ...
                 <div class="product_description">
                 	<p>This is used for the treatment of asthama.This is of highly reactive medicine.</p>
                 	<a href='book.php?rn=Calpol & sb=10' class="buy_now">Buy now</a>
                 </div>
				</li>
				...
				<li>
                 ...
                 <div class="product_description">
                 	<p>This is used for the treatment of asthama.This is of highly reactive medicine.</p>
                 	<a href='book.php?rn=Odizox & sb=120' class="buy_now">Buy now</a>
                 </div>
				</li>
				...
				<li>
                 ...
                 <div class="product_description">
                 	<p>This is used for the treatment of asthama.This is of highly reactive medicine.</p>
                 	<a href="book.php?rn=Paracetamol & sb=70" class="buy_now">Buy now</a>
                 </div>
				</li>
