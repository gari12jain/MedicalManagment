...
while($arr=mysqli_fetch_assoc($ans))
{
	...
	<td><a href='edit_product.php?ab=$arr[ProductName] & cd=$arr[SupplierName] & ef=$arr[Price] & gh=$arr[Stock] & ij=$arr[total]'>Edit</a></td>
	<td><a href='delete_product.php?del=<?php echo $arr[SupplierName]?>;'>Delete</a></td>
	</tr>";
