...
.buttons a {
	...
	<body>
		...
		<div>
			<form id="contact-form" action="save.php" method="post">
          <fieldset>
          	
		   <label><span class="text-form" >Name:</span>
              <input name="SupplierName" type="text" required /></label>
            ...
            <label><span class="text-form">Phone_no:</span>
			 ...
			 <a href="update.php"><input type="button" name="submit" value="Update"></a>
			</fieldset>
		</form>
		</div>
