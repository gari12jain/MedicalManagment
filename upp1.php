...
.buttons a {
	...
	<body>
		...
		<div id="navbar">
			...
			<div>
				 <h3 class="p1">Update Item</h3>
			<form id="contact-form" action="save2.php"  method="GET">
          <fieldset>
          	
		   <label><span class="text-form" >Name:</span>
              <input name="SupplierName" type="text" value="<?php echo $_GET['rn'];?>"></label>
            <label><span class="text-form">Company Name:</span>
              <input name="Company" type="text" value="<?php echo $_GET['sn'];?>">
            </label>
            <label><span class="text-form">Email:</span>
              <input name="Email" type="email" value="<?php echo $_GET['cl'];?>"></label>
			 <label><span class="text-form">Address:</span>
              <input name="Address" type="text" value="<?php echo $_GET['ab'];?>">
            </label>
            <label><span class="text-form">Phone_no:</span>
              <input name="Contact" type="text" value="<?php echo $_GET['rl'];?>">
            </label>
