  ...
  <body>
    ...
    <div>
      <form id="contact-form"  method="post">
       ...
       <label><span class="p_name">Product Name:</span>
              <input name="name" type="text" required /></label>
            <label><span class="c_name">Company Name:</span>
              <input name="name" type="text" required />
            </label>
            <label><span class="price">Price:</span>
              <input name="num" type="num" required /></label>
            <label><span class="text-form">Quantity:</span>
              <input name="num" type="num" required />
            </label>
